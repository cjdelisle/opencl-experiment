...
// nothing required, so we'll require everything
#ifndef CL_TARGET_OPENCL_VERSION
    #define CL_TARGET_OPENCL_VERSION CL_VERSION_2_0
    #define NEED_cl_amd_media_ops
    #define NEED_cl_amd_media_ops2
    #define NEED_cl_intel_device_side_avc_motion_estimation
    #define NEED_cl_intel_planar_yuv
    #define NEED_cl_intel_subgroups
    #define NEED_cl_intel_subgroups_short
    #define NEED_cl_khr_3d_image_writes
    #define NEED_cl_khr_depth_images
    #define NEED_cl_khr_fp16
    #define NEED_cl_khr_fp64
    #define NEED_cl_khr_gl_msaa_sharing
    #define NEED_cl_khr_global_int32_base_atomics
    #define NEED_cl_khr_global_int32_extended_atomics
    #define NEED_cl_khr_int64_base_atomics
    #define NEED_cl_khr_int64_extended_atomics
    #define NEED_cl_khr_local_int32_base_atomics
    #define NEED_cl_khr_local_int32_extended_atomics
    #define NEED_cl_khr_mipmap_image
    #define NEED_cl_khr_subgroups
#endif

#define OPENCL_DEFINE_DUMMY(x) typedef struct x ## _s* x;
...
#define long _long
#else
#error "neither __SIZEOF_LONG__ nor __SIZEOF_LONG_LONG__ is 8"
#endif
...
// setup according to what is demanded by the caller
#define __OPENCL_VERSION__ CL_TARGET_OPENCL_VERSION
#define __OPENCL_C_VERSION__ CL_TARGET_OPENCL_VERSION

#ifdef NEED_cl_amd_media_ops
#define cl_amd_media_ops 1
#endif
#ifdef NEED_cl_amd_media_ops2
#define cl_amd_media_ops2 1
#endif

#ifdef NEED_cl_intel_device_side_avc_motion_estimation
#define cl_intel_device_side_avc_motion_estimation 1
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ime_payload_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ime_result_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_sic_payload_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_sic_result_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_mce_payload_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_mce_result_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ref_payload_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ref_result_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ime_result_single_reference_streamout_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ime_result_dual_reference_streamout_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ime_single_reference_streamin_t)
OPENCL_DEFINE_DUMMY(intel_sub_group_avc_ime_dual_reference_streamin_t)
#endif
#ifdef NEED_cl_intel_planar_yuv
#define cl_intel_planar_yuv 1
#endif
#ifdef NEED_cl_intel_subgroups
#define cl_intel_subgroups 1
#endif
#ifdef NEED_cl_intel_subgroups_short
#define cl_intel_subgroups_short 1
#endif

#ifdef NEED_cl_khr_3d_image_writes
#define cl_khr_3d_image_writes 1
#endif
#ifdef NEED_cl_khr_depth_images
#define cl_khr_depth_images 1
#endif
#ifdef NEED_cl_khr_fp16
#define cl_khr_fp16 1
#endif
#ifdef NEED_cl_khr_fp64
#define cl_khr_fp64 1
#endif
#ifdef NEED_cl_khr_gl_msaa_sharing
#define cl_khr_gl_msaa_sharing 1
#endif
#ifdef NEED_cl_khr_global_int32_base_atomics
#define cl_khr_global_int32_base_atomics 1
#endif
#ifdef NEED_cl_khr_global_int32_extended_atomics
#define cl_khr_global_int32_extended_atomics 1
#endif
#ifdef NEED_cl_khr_int64_base_atomics
#define cl_khr_int64_base_atomics 1
#endif
#ifdef NEED_cl_khr_int64_extended_atomics
#define cl_khr_int64_extended_atomics 1
typedef long atomic_long;
typedef ulong atomic_ulong;
typedef uintptr_t atomic_uintptr_t;
typedef intptr_t atomic_intptr_t;
typedef double atomic_double;
#endif
#ifdef NEED_cl_khr_local_int32_base_atomics
#define cl_khr_local_int32_base_atomics 1
#endif
#ifdef NEED_cl_khr_local_int32_extended_atomics
#define cl_khr_local_int32_extended_atomics 1
#endif
#ifdef NEED_cl_khr_mipmap_image
#define cl_khr_mipmap_image 1
#endif
#ifdef NEED_cl_khr_subgroups
...
OPENCL_DEFINE_DUMMY(image1d_array_t)
OPENCL_DEFINE_DUMMY(image1d_buffer_t)
OPENCL_DEFINE_DUMMY(image1d_t)
OPENCL_DEFINE_DUMMY(image2d_array_depth_t)
OPENCL_DEFINE_DUMMY(image2d_array_msaa_depth_t)
OPENCL_DEFINE_DUMMY(image2d_array_msaa_t)
OPENCL_DEFINE_DUMMY(image2d_array_t)
OPENCL_DEFINE_DUMMY(image2d_depth_t)
OPENCL_DEFINE_DUMMY(image2d_msaa_depth_t)
OPENCL_DEFINE_DUMMY(image2d_msaa_t)
OPENCL_DEFINE_DUMMY(image2d_t)
OPENCL_DEFINE_DUMMY(image3d_t)
OPENCL_DEFINE_DUMMY(image_channel_data_t)
OPENCL_DEFINE_DUMMY(sampler_t)

OPENCL_DEFINE_DUMMY(event_t)
OPENCL_DEFINE_DUMMY(reserve_id_t)
OPENCL_DEFINE_DUMMY(clk_event_t)
OPENCL_DEFINE_DUMMY(queue_t)
#endif
...
#ifndef __STDC__
// these appear as broken overloads because the compiler doesn't understand __global and __local
...
#ifdef __STDC__
int __ovld enqueue_kernel(queue_t q, kernel_enqueue_flags_t f, const ndrange_t r, void (^block)(void));
int __ovld enqueue_kernel(queue_t q, kernel_enqueue_flags_t f, const ndrange_t r,
...
uint2 intel_sub_group_avc_mce_get_default_high_penalty_cost_table();
uint2 intel_sub_group_avc_mce_get_default_medium_penalty_cost_table();
uint2 intel_sub_group_avc_mce_get_default_low_penalty_cost_table();
uint intel_sub_group_avc_mce_get_default_non_dc_luma_intra_penalty();
uchar intel_sub_group_avc_mce_get_default_intra_chroma_mode_base_penalty();
